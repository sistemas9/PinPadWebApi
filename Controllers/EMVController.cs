...
namespace PinPadWebApi
{
  ...
  public class EMVController : ControllerBase
  {
    ...
    public bool login()
    {
      ...
      URL_PublicKey = "https://key.mitec.com.mx";
      Url = "https://ssl.e-pago.com.mx";
      //Url = Program.Url;
    ...
    public DatosVoucher EjecutaCobro(String refer,String origen, String amount)
    {
      ...
      cpIntegraEMV.dbgSetActivateMagtek(true);
      cpIntegraEMV.dbgSetUrl("https://ssl.e-pago.com.mx");
      cpIntegraEMV.dbgSetUrlIpKeyWeb("https://ssl.e-pago.com.mx");
      if (HidePPMoneda)
      {
